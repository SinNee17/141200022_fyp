			...
			<form action="partials/_menuManage.php" method="post" enctype="multipart/form-data">
				<div class="card mb-3">
					...
					<div class="card-footer">
						<div class="row">
							<div class="col-md-12">
								<button type="submit" name="createItem" class="btn btn-sm btn-primary" style="background-color: #5585b5; border:#5585b5;"> Create </button>
							</div>
						</div>
					</div>
				</div>
						...
						<table class="table table-bordered table-hover mb-0">
                            ...
                            <?php
                                ...
                                while($row = mysqli_fetch_assoc($result)){
                                    ...
                                    echo '<tr>
                                            <td>
                                                <img src="/OnlineFoodOrdering/img/pizza-'.$pizzaId. '.jpg" alt="image for this item" width="150px" height="150px">
                                            </td>
                                            <td>
                                            ...
                                            <td class="text-center">
												<div class="row mx-auto" style="width:112px">
													<button class="btn btn-sm btn-primary" type="button" data-toggle="modal" style="background-color: #5585b5; border:#5585b5;"data-target="#updateItem' .$pizzaId. '">Edit</button>
													<form action="partials/_menuManage.php" method="POST">
														<button name="removeItem" class="btn btn-sm btn-danger" style="margin-left: 5px;background-color: #f83e4b; border: #f83e4b;">Delete</button>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
	  	<form action="partials/_menuManage.php" method="post" enctype="multipart/form-data">
		    <div class="text-left my-2 row" style="border-bottom: 2px solid #dee2e6;">
		   		<div class="form-group col-md-8">
					...
					<button type="submit" class="btn btn-success my-1" name="updateItemPhoto" style="background-color: #5585b5; border:#5585b5;">Update Image</button>
				</div>
		...
		<form action="partials/_menuManage.php" method="post">
            ...
            <input type="hidden" id="pizzaId" name="pizzaId" value="<?php echo $pizzaId; ?>">
            <button type="submit" class="btn btn-success" name="updateItem" style="background-color: #5585b5; border:#5585b5;">Update</button>
        </form>
      </div>
    </div>
  </div>
