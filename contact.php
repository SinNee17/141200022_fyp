...
<html lang="en">
  ...
  <?php include 'partials/_nav.php';?>
      ...
      <div class="contact2" style="background-image:url(img/Food-Ordering-System.jpg);height: 400px;" id="contact">
        <div class="container">
                        ...
                        <div class="col-lg-12">
                          ...
                          <div class="col-lg-12">
                            <div class="form-group mt-3">
                              ...
                              <input class="form-control" id="password" name="password" placeholder="Enter Password" type="password" placeholder="Enter Your Password">
                            </div>
                          </div>
                          <div class="col-lg-12">
                            <div class="form-group  mt-3">
                              <b><label for="password">Comment:</label></b>
                                <textarea class="form-control" id="message" name="message" rows="2" required minlength="6" placeholder="Your Comment"></textarea>
                            </div>
                          </div>
                          <?php if($loggedin){ ?>
                            <div class="col-lg-12">
                              <button type="submit" class="btn btn-danger-gradiant mt-3 mb-3 text-white border-0 py-2 px-3"><span> Submit<i class="ti-arrow-right"></i></span></button>
                          ...
                          <?php }else { ?>
                            <div class="col-lg-12">
                              <button type="submit" class="btn btn-danger-gradiant mt-3 text-white border-0 py-2 px-3" disabled><span> Submit <i class="ti-arrow-right"></i></span></button>
                            </div>
                          <?php } ?>
                        </div>
                      </form>
      ...
      <div class="modal fade" id="adminReply" tabindex="-1" role="dialog" aria-labelledby="adminReply" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
          <div class="modal-content">
            <div class="modal-header" style="background-color: #fdffcd;">
