                    ...
                    <?php
                        ...
                        while($row = mysqli_fetch_assoc($result)){
                            ...
                            echo '<tr>
                                    ...
                                    <td>' . $paymentMode . '</td>
                                    <td>' . $orderDate . '</td>
                                <td><a href="#" data-toggle="modal" data-target="#orderItem' . $orderId . '" ><p>Click</p></a></td>
                                <td><a href="#" data-toggle="modal" data-target="#orderStatus' . $orderId . '" ><p>Click</p></a></td>

                                </tr>';
                        }
                        
                        if($counter==0) {
                            ?><script> document.getElementById("empty").innerHTML = '<div class="col-md-12 my-5"><div class="card"><div class="card-body cart"><div class="col-sm-12 empty-cart-cls text-center"><h3><strong>You have not ordered any items.</strong></h3><a href="index.php" class="btn btn-primary cart-btn-transform m-3" data-abc="true"style="background-color:#668ba4; color:white; border:#668ba4;">continue shopping</a> </div></div></div></div>';</script> <?php
                        }
                    ?>
                </tbody>
            </table>
