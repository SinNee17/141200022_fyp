                ...
                echo '<div class="col-xs-3 col-sm-3 col-md-3">
                    <div class="card" style="width: 18rem;">
                        ...
                        <div class="card-body">
                            ...
                            <a href="viewPizzaList.php?catid=' . $catId . '" class="btn btn-primary" style="background-color:#668ba4; color:white; border:#668ba4;">View All</a>
                        </div>
                    </div>
                </div>';
            }
                ...
                echo '<div class="col-xs-3 col-sm-3 col-md-3">
                    <div class="card" style="width: 18rem;">
                        ...
                        <div class="card-body">
                            ...
                            <h6 style="color: #42b883">RM'.$pizzaPrice. '</h6>
                                ...
                                if($loggedin){
                                    ...
                                    if($quaExistRows == 0) {
                                        echo '<form action="partials/_manageCart.php" method="POST">
                                              ...
                                              <button type="submit" name="addToCart" class="btn btn-primary mx-2" style="background-color:#668ba4; color:white; border:#668ba4;">Add to Cart</button>';
                                    }else {
                                        echo '<a href="viewCart.php"><button class="btn btn-primary mx-2" style="background-color:#668ba4; color:white; border:#668ba4;">Go to Cart</button></a>';
                                    }
                                }
                                else{
                                    echo '<button class="btn btn-primary mx-2" data-toggle="modal" data-target="#loginModal" style="background-color:#668ba4; color:white; border:#668ba4;">Add to Cart</button>';
                                }
                                echo '</form>
                                <a href="viewPizza.php?pizzaid=' . $pizzaId . '"><button class="btn btn-primary" style="background-color:#668ba4; color:white; border:#668ba4;">Quick View</button></a>
                            </div>
                        </div>
                    </div>
                </div>';
