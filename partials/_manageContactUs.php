...
if($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (password_verify($password, $passRow['password'])){
        ...
        echo '<script>alert("Thanks for Contact us. Your contact id is ' .$contactId. '. We will contact you soon.");
                    window.location.href="http://localhost/OnlineFoodOrdering/index.php";  
                    </script>';
                    exit();
    }
    else{
